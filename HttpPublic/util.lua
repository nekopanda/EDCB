...
function RecSettingTemplate(rs)
  local s='<ul><li>録画モード</li>\n<li class="select"><select name="recMode">\n'
    ...
    ..'<ul class="check bottom"><li>録画マージン</li><li class="sp"><input id="usedef" type="checkbox" name="useDefMarginFlag" value="1"'..(rs.startMargin and '' or ' checked')..'><label for="usedef">デフォルト設定で使用</label></li></ul>\n'
    ..'<ul><li></li><li><ul class="compact margin'..(rs.startMargin and '' or ' disabled')..'"><li class="float half"><ul class="sbs"><li>開始</li>\n<li class="sp"><input type="number" name="startMargin" value="'..(rs.startMargin or 0)..'"'..(rs.startMargin and '' or ' disabled')..'>秒前</li></ul></li>\n'
    ..'<li class="half sp"><ul class="sbs"><li>終了</li>\n<li class="sp"><input type="number" name="endMargin" value="'..(rs.endMargin or 0)..'"'..(rs.startMargin and '' or ' disabled')..'>秒後</li></ul></li></ul></li></ul>\n'
    ..'<ul class="check bottom"><li>指定サービス対象データ</li><li class="sp"><input id="smode" type="checkbox" name="serviceMode" value="0"'..(rs.serviceMode%2==0 and ' checked' or '')..'><label for="smode">デフォルト設定で使用</label></li></ul>\n'
    ...
    ..'<ul class="check"><li>連続録画動作</li><li><input id="continue" type="checkbox" name="continueRecFlag" value="1"'..(rs.continueRecFlag and ' checked' or '')..'><label for="continue">後ろの予約を同一ファイルで出力する</label></li></ul>\n'
  ...
  s=s..'</div><input type=hidden name="recFolderCount" value="0">\n'
    ..'<ul class="check bottom"><li>部分受信サービス</li><li class="sp"><input id="partial" type="checkbox" name="partialRecFlag" value="1"'..(rs.partialRecFlag~=0 and ' checked' or '')..'><label for="partial">別ファイルに同時出力する</label></li></ul>\n'
